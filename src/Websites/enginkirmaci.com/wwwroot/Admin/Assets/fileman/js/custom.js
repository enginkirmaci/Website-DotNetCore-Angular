...
function FileSelected(file) {
    ...
    var modal = RoxyUtils.GetUrlParam('modal');
    var fieldId = RoxyUtils.GetUrlParam('fieldId');

    $('#' + fieldId, window.parent.document).attr('src', file.fullPath);
    $('#' + fieldId + 'Hidden', window.parent.document).val(file.fullPath);
